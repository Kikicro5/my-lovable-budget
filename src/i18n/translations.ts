...
export const translations: Record<Language, Record<string, string>> = {
  hr: {
    ...
    // Push notifications
    'notifications.pushTitle': 'Push obavijesti',
    'notifications.pushDescription': 'Primaj obavijesti čak i kada aplikacija nije otvorena.',
    'notifications.pushStatus': 'Status push obavijesti',
    'notifications.enablePush': 'Omogući push obavijesti',
    'notifications.granted': 'Odobreno',
    'notifications.denied': 'Odbijeno',
    'notifications.unsupported': 'Nije podržano',
    'notifications.notSet': 'Nije postavljeno',
    'notifications.types': 'Vrste obavijesti',
    'notifications.budgetAlerts': 'Upozorenja o budžetu (80%)',
    'notifications.weeklyReport': 'Tjedni izvještaj',
    'notifications.monthEndReminder': 'Podsjetnik za kraj mjeseca',
    'notifications.largeTransaction': 'Velike transakcije',
  ...
  en: {
    ...
    'notifications.pushDescription': 'Receive notifications even when the app is closed.',
    'notifications.pushStatus': 'Push notification status',
    ...
    'notifications.notSet': 'Not set',
    'notifications.types': 'Notification types',
    'notifications.budgetAlerts': 'Budget alerts (80%)',
    'notifications.weeklyReport': 'Weekly report',
    'notifications.monthEndReminder': 'Month end reminder',
    'notifications.largeTransaction': 'Large transactions',
  ...
  de: {
    ...
    // Push notifications
    'notifications.pushTitle': 'Push-Benachrichtigungen',
    'notifications.pushDescription': 'Erhalten Sie Benachrichtigungen auch wenn die App geschlossen ist.',
    'notifications.pushStatus': 'Push-Benachrichtigungsstatus',
    'notifications.enablePush': 'Push-Benachrichtigungen aktivieren',
    'notifications.granted': 'Gewährt',
    'notifications.denied': 'Abgelehnt',
    'notifications.unsupported': 'Nicht unterstützt',
    'notifications.notSet': 'Nicht eingestellt',
    'notifications.types': 'Benachrichtigungsarten',
    'notifications.budgetAlerts': 'Budgetwarnungen (80%)',
    'notifications.weeklyReport': 'Wochenbericht',
    'notifications.monthEndReminder': 'Monatsend-Erinnerung',
    'notifications.largeTransaction': 'Große Transaktionen',
  ...
  pl: {
    ...
    // Push notifications
    'notifications.pushTitle': 'Powiadomienia push',
    'notifications.pushDescription': 'Otrzymuj powiadomienia nawet gdy aplikacja jest zamknięta.',
    'notifications.pushStatus': 'Status powiadomień push',
    'notifications.enablePush': 'Włącz powiadomienia push',
    'notifications.granted': 'Przyznano',
    'notifications.denied': 'Odmówiono',
    'notifications.unsupported': 'Nieobsługiwane',
    'notifications.notSet': 'Nie ustawiono',
    'notifications.types': 'Rodzaje powiadomień',
    'notifications.budgetAlerts': 'Ostrzeżenia o budżecie (80%)',
    'notifications.weeklyReport': 'Tygodniowy raport',
    'notifications.monthEndReminder': 'Przypomnienie o końcu miesiąca',
    'notifications.largeTransaction': 'Duże transakcje',
  ...
  es: {
    ...
    'notifications.pushDescription': 'Recibe notificaciones incluso cuando la app está cerrada.',
    'notifications.pushStatus': 'Estado de notificaciones push',
    'notifications.enablePush': 'Habilitar notificaciones push',
    'notifications.granted': 'Concedido',
    'notifications.denied': 'Denegado',
    'notifications.unsupported': 'No compatible',
    'notifications.notSet': 'No configurado',
    'notifications.types': 'Tipos de notificaciones',
    'notifications.budgetAlerts': 'Alertas de presupuesto (80%)',
    'notifications.weeklyReport': 'Informe semanal',
    'notifications.monthEndReminder': 'Recordatorio fin de mes',
    'notifications.largeTransaction': 'Transacciones grandes',
  ...
  fr: {
    ...
    'notifications.pushDescription': 'Recevez des notifications même lorsque l\'app est fermée.',
    'notifications.pushStatus': 'Statut des notifications push',
    'notifications.enablePush': 'Activer les notifications push',
    'notifications.granted': 'Accordé',
    'notifications.denied': 'Refusé',
    'notifications.unsupported': 'Non supporté',
    'notifications.notSet': 'Non configuré',
    'notifications.types': 'Types de notifications',
    'notifications.budgetAlerts': 'Alertes de budget (80%)',
    'notifications.weeklyReport': 'Rapport hebdomadaire',
    'notifications.monthEndReminder': 'Rappel de fin de mois',
    'notifications.largeTransaction': 'Grandes transactions',
