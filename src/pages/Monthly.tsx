      ...
      <div className="max-w-lg mx-auto px-4">
        ...
        <Tabs defaultValue="income" className="w-full">
          <TabsList className="w-full grid grid-cols-5 mb-6">
            ...
            <TabsTrigger value="expense" className="flex items-center gap-1 text-xs px-2"><TrendingDown className="w-3 h-3" /><span className="hidden sm:inline">{t('monthly.expense')}</span></TabsTrigger>
            <TabsTrigger value="investment" className="flex items-center gap-1 text-xs px-2"><LineChart className="w-3 h-3" /><span className="hidden sm:inline">{t('monthly.investment')}</span></TabsTrigger>
            <TabsTrigger value="savings" className="flex items-center gap-1 text-xs px-2"><PiggyBank className="w-3 h-3" /><span className="hidden sm:inline">{t('monthly.savings')}</span></TabsTrigger>
            <TabsTrigger value="categories" className="flex items-center gap-1 text-xs px-2"><Tags className="w-3 h-3" /><span className="hidden sm:inline">{t('monthly.categories')}</span></TabsTrigger>
          </TabsList>
